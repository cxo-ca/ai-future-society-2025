...
- 인공지능을 학습시킬 권리
- 인공지능 윤리 가이드
- 공학자를 위한 윤리, 그리고 사회 전체의 책임
- 신뢰 기반 블록체인 기술, 과연 신뢰해도 되는가?

## 2. 강의 핵심 내용 요약
- 강의는 먼저 '신뢰 기반의 블록체인 기술, 정말 신뢰해도 되는가?'라는 질문으로 시작해, 기술이 약속하는 신뢰와 실제 사회에서 발생할 수 있는 문제 사이에 간극이 있다는 점을 짚었다. 기술적으로 조작이 어렵다고 해서, 그 위에서 돌아가는 모든 행위까지 자동으로 윤리적이거나 공정한 것은 아니라는 점을 강조했다.  
- 지적재산권과 인공지능 파트에서는,  
...
- 인공지능 학습과 윤리 파트에서는,  
  - 학습 데이터의 윤리: 동의 없는 수집, 편향된 데이터, 차별적인 표현이 포함된 데이터 등이 나중에 모델의 편향으로 이어질 수 있다는 점,  
  ...
  - 인공지능을 학습시킬 권리: 누구나 데이터를 모아 모델을 학습시킬 권리가 있는지, 혹은 일정한 규제와 동의 절차가 필요한지에 대한 논의를 다루었다.  
- 인공지능 윤리 파트에서는,  
  - 윤리란 무엇인지, 단순히 법을 지키는 수준을 넘어 '무엇이 옳은가'를 고민하는 철학적·실천적 기준이라는 점을 짚고,  
  - 여러 나라와 기관에서 제시한 인공지능 윤리 가이드(투명성, 공정성, 책임성, 안전, 프라이버시 존중 등)의 공통 요소를 간단히 정리했다.  
  - 마지막으로 '이런 윤리는 공학자만 잘 지키면 되는가?'라는 질문을 던지며, 인공지능이 사회 전반에 영향을 미치는 만큼 개발자뿐 아니라 기획자, 경영자, 정책 결정자, 사용자 모두가 함께 고민해야 한다는 관점을 제시했다.  
...
- 각 나라나 기관에서 제시한 인공지능 윤리 가이드라인(공정성, 투명성, 책임성 등)을
